...
const totalPopulation = populations.reduce((acc, num) => {
  return acc + num;
});
...
// Do not edit the code below.
//this is an array of objects (meaning I can call element.monster or element.CP during the loop)
...
const sum = purchases.reduce((acc, num) => {
