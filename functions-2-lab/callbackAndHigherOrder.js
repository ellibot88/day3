...
// const each = (array, location) => {
//   for (let i = 0; i < array.length; i++) {
//     return location(array[i], i);
//   }
// };
...
const getUserById = (user, id, callback) => {
...
getUserById(users, "16t", student);

////////// CHALLENGE //////////

const multiplyFactory = (x) => (y) => x * y;

const multiplyBy5 = multiplyFactory(5);
console.log(multiplyBy5(7));

const myFavoriteMultiple = multiplyFactory(88);
console.log(myFavoriteMultiple(10));
...
const addFavorite = addingFactory(88);
console.log(addFavorite(12));
